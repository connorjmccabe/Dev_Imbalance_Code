...
#Need to update readRDS at some point
#This should work but doesn't:

githubURL <- ("https://github.com/connorjmccabe/Dev_Imbalance_Code/blob/master/uncon_sex.RDS")
download.file(githubURL,"test.rds", method="curl")
uncon_sex <- readRDS("test.rds")

test<-readRDS(url("https://github.com/connorjmccabe/Dev_Imbalance_Code/blob/master/uncon_sex.RDS"))
uncon.full<-readRDS("uncon_full.RDS")
...
uncon.sex<-readRDS("uncon_sex.rds")
...
sspmthed<-readRDS("sspmthed_full.rds")
